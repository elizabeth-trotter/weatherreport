      ...
      <div className='bgBlueBody rounded-md'>
        ...
        <div className='flex flex-row justify-around py-6'>
          <div className='flex flex-col justify-center items-center gap-11 pb-3'>
            ...
            <FontAwesomeIcon icon={props.morningIcon} className='text-3xl'/>
          ...
          <div className='flex flex-col justify-center items-center gap-11 pb-3'>
            ...
            <FontAwesomeIcon icon={props.noonIcon} className='text-3xl'/>
          ...
          <div className='flex flex-col justify-center items-center gap-11 pb-3'>
            ...
            <FontAwesomeIcon icon={props.nightIcon} className='text-3xl'/>
